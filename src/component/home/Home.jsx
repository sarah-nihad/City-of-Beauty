...
import Videoo from '../common/Videoo'
                        ...
                        <div onLoad={this.handleLoad} id='min1_home1' >
                            ...
                            <div id='headerHomeContiner'>
                                ...
                                <div id='editBugHeader'>
                                    <div id='upNavBar' >
                                        <div id='upNavBar1'>
                                            ...
                                            <i className="fas fa-map-marker-alt " id='IconHomeUP'><span id='SPanUPNav'>Iraq/Baghdad</span></i>
                                        </div>
                                        <div id='upNavBar2'>
                                ...
                                <div id='downHeaderNavContiner'>
                                    ...
                                    <div id='OurProdectContinerss' style={{ backgroundColor: '#F8F6EA',paddingBottom:100 }}  >
                                                        ...
                                                        {matches.small &&
                                                            <div style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff' }} >
                                                                ...
                                                                >
                                                                    ...
                                                                    <div style={{ backgroundColor: '#fff' }} id='perfume1' >
                                                                        <img id='slid_img' src={require('../../assets/img/dermaa.png')} alt='img' />
                                                                    </div>
...
<Videoo />
                                    ...
                                    <div id='HomeAboutUSContiner' style={{ backgroundColor: '#EDECE8' }}  >
                                        <div style={{ width: '60%', padding: '30px' }} id='te_homr'  >
                                            ...
                                            <div style={{ fontFamily: 'Playball' }}> ABOUT US :  </div>
